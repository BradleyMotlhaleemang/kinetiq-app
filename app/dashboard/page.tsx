        ...
        {mesocycle && (
          <div className="rounded-xl bg-zinc-900 border border-zinc-800 p-4">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-zinc-300 text-sm font-medium">Current Block</span>
            </div>
        ...
        {recentWorkouts.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-zinc-300 text-sm font-medium">Recent Sessions</span>
            </div>
                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-right">
                      <p className="text-white text-sm">{workout.totalSets} sets</p>
